...
GO
INSERT INTO Category ([category_id], [blog_id], [parent_category_id], [name], [description]) VALUES (1,'default',NULL,'/uncategorized/','Uncategorized');
...
GO
INSERT INTO DBUser (user_id, user_login, user_password, user_name, user_email, user_registered, user_status, blog_id) VALUES (1,'default','default','Default User','default_owner@email.com',getdate(),'','default');
...
CREATE TABLE [Plugin] (
	...
	[plugin_value] [nvarchar] (4096) NULL
) ON [PRIMARY]
GO
